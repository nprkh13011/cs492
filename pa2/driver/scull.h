...
/* struct task_info can be defined in header instead of rewriting 
 * in all the included files.
 */
struct task_info {
	long state;
	void *stack;
...
/*
 * it accepts a struct of a task_info struct
 */

/* ... more to come */

#define SCULL_IOC_MAXNR 7 /*change it to 7 since we added 'I' case */
